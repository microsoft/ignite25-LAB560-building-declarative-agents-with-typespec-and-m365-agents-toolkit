...
> [!NOTE] 
> If for some reason the action "Provsion" fails, check your **.env.dev** file to see if if you have a variable **AGENT_SCOPE=**. If present, change the variable value from `shared` to `personal`. 
